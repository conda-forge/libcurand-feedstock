About libcurand-split-feedstock
===============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libcurand-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libcurand-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add libcurand libcurand-dev libcurand-static
# for installing globally
pixi global install libcurand libcurand-dev libcurand-static
```
...
It is possible to list all of the versions of `libcurand` available on your platform:
...
```
pixi search libcurand --channel conda-forge
```
